...
const OperationGreeterDeleteCollection = "/service.wireman.Greeter/DeleteCollection"
...
func RegisterGreeterHTTPServer(s *http.Server, srv GreeterHTTPServer) {
	...
	r.DELETE("/collection/{id}", _Greeter_DeleteCollection0_HTTP_Handler(srv))
}
...
func _Greeter_DeleteCollection0_HTTP_Handler(srv GreeterHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationGreeterDeleteCollection)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
		...
		reply := out.(*DeleteCollectionReply)
		return ctx.Result(200, reply)
	}
}
...
type GreeterHTTPClient interface {
	...
	DeleteCollection(ctx context.Context, req *DeleteCollectionRequest, opts ...http.CallOption) (rsp *DeleteCollectionReply, err error)
...
func (c *GreeterHTTPClientImpl) DeleteCollection(ctx context.Context, in *DeleteCollectionRequest, opts ...http.CallOption) (*DeleteCollectionReply, error) {
	var out DeleteCollectionReply
	pattern := "/collection/{id}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationGreeterDeleteCollection))
	opts = append(opts, http.PathTemplate(pattern))
